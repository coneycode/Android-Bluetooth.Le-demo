/**   
* @Title: DeviceControlActivity.java 
* @Package com.coney.demo.ble 
* @Description: TODO
* @author coney Geng
* @date 2014年11月14日 下午2:59:36 
* @version V1.0   
*/
package com.coney.demo.ble;
...
/** 
 * @ClassName: DeviceControlActivity 
 * @Description: TODO
 * @author coney Geng
 * @date 2014年11月14日 下午2:59:36 
 *  
...
public class DeviceControlActivity  extends Activity {
    ...
    private BluetoothLeGattService mBluetoothLeService;
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            MyLogger.i(mBluetoothLeService + "");
